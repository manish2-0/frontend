...
export default function Admin() {
  ...
  const handleChange = (e) => {
    ...
    setErrors({
      ...errors,
      [name]: "", // Clear previous error when user types
    });
  };
  ...
  return (
    <>
      <div>
        ...
        <div className="mx-auto w-full h-[500px] max-w-sm lg:w-96 absolute inset-0 top-[200px] bg-white ">
          <div className="border-white border  p-5 ">
            <div className="">
              <img
